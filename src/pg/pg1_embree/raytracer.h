...
private:
    ...
    Vector3
    get_color_glass(Ray &ray, Vector3 hit_point, Vector3 omni_light_position, Vector3 normal, Vector3 v, Vector3 l,
                    Vector3 diffuse_color_v, Vector3 specular_color_v, int depth, int max_depth, Material *material,
                    float ior_from);
};
